...
def transform_gradle(text: str) -> str:
    ...
    text = replace_once(text, 'versionCode = generatedVersionCode', 'versionCode = 4')
    return replace_once(text, 'versionName = generatedVersionName', 'versionName = "0.2.0-dev.3"')
